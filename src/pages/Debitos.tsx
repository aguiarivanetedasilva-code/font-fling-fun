        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50">
          <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-lg mx-4 mb-0 sm:mb-0 p-8 relative">
            ...
            <p className="text-center text-sm text-gray-600 mb-6">
              ...
              <span className="text-red-600 font-bold underline">R$ 195,23</span> e{" "}
            ...
            <button
              ...
              className="w-full py-4 rounded-lg bg-red-600 text-yellow-300 font-bold text-base tracking-wider hover:bg-red-700 transition-colors"
            >
              CONTINUAR
            </button>
          </div>
